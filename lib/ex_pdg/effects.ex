defmodule ExPDG.Effects do
  ...
  @pure_modules [
    Enum, Stream, Map, Keyword, List, Tuple, String, Atom,
    Integer, Float, MapSet, Range, Regex, URI, Path, Base,
    Bitwise, Macro, Module, Version,
    :lists, :maps, :ordsets, :orddict, :sets, :gb_sets,
    :gb_trees, :dict, :proplists, :string, :binary,
    :math, :unicode, :filename, :re
  ]
  ...
  @pure_kernel_functions [
    ...
    :max, :min, :hd, :tl, :length, :elem, :tuple_size,
    :map_size, :is_atom, :is_binary, :is_bitstring, :is_boolean,
    :is_float, :is_function, :is_integer, :is_list, :is_map,
    :is_nil, :is_number, :is_pid, :is_port, :is_reference,
    :is_tuple, :is_map_key, :node, :self, :binary_part,
    :bit_size, :byte_size, :is_exception, :is_struct,
    :to_string, :to_charlist, :inspect
  ]

  @pure_erlang_functions [
    {:erlang, :abs, 1}, {:erlang, :element, 2}, {:erlang, :hd, 1},
    {:erlang, :length, 1}, {:erlang, :map_size, 1}, {:erlang, :max, 2},
    {:erlang, :min, 2}, {:erlang, :node, 0}, {:erlang, :self, 0},
    {:erlang, :tl, 1}, {:erlang, :tuple_size, 1}, {:erlang, :tuple_to_list, 1},
    {:erlang, :list_to_tuple, 1}, {:erlang, :atom_to_binary, 1},
    {:erlang, :binary_to_atom, 1}, {:erlang, :integer_to_binary, 1},
    {:erlang, :binary_to_integer, 1}, {:erlang, :float_to_binary, 1},
    {:erlang, :binary_to_float, 1}, {:erlang, :term_to_binary, 1},
    {:erlang, :binary_to_term, 1}, {:erlang, :phash2, 1}, {:erlang, :phash2, 2},
    {:erlang, :size, 1}, {:erlang, :bit_size, 1}, {:erlang, :byte_size, 1},
    {:erlang, :is_atom, 1}, {:erlang, :is_binary, 1}, {:erlang, :is_boolean, 1},
    {:erlang, :is_float, 1}, {:erlang, :is_integer, 1}, {:erlang, :is_list, 1},
  ...
  defp ets_write?(:ets, f) when f in [:insert, :insert_new, :delete, :delete_object,
                                       :update_counter, :update_element], do: true
  defp ets_write?(_, _), do: false

  defp ets_read?(:ets, f) when f in [:lookup, :lookup_element, :match, :match_object,
                                      :select, :member, :info, :tab2list, :first,
                                      :next, :last, :prev, :foldl, :foldr], do: true
